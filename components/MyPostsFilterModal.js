...
const statuses = ['All', 'Active', 'Claimed'];
const sortOptions = ['Newest First', 'Oldest First'];

const MyPostsFilterModal = ({ visible, onClose, onApply, initialFilters = {} }) => {
  ...
  useEffect(() => {
    if (visible) {
      ...
      setSelectedSort(initialFilters.sort || 'Newest First');
    }
...
export default MyPostsFilterModal;
